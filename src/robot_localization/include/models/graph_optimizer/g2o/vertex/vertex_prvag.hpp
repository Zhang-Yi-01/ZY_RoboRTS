...
public:
    ...
    virtual bool read(std::istream &in) { (void)in; return true; }// 避免 unuse warning

    virtual bool write(std::ostream &out) const { (void)out; return true; }// 避免 unuse warning
...
#endif // MODELS_GRAPH_OPTIMIZER_G2O_VERTEX_VERTEX_PRVAG_HPP_
